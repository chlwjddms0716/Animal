## HomelessAnimalManagementSystem 
...
- 검색 기능 :
필요한 유기유실동물의 정보만 가져올 수 있도록 보호센터, 성별, 종, 신고일 별로 필터하여 검색할 수 있습니다.
...
- 검색 기능 : 전체 입양가능한 유기유실동물을 대상으로 종, 성별 별로 필터하여 검색 할 수 있습니다.
...
동물 이름, 종, 잃어버린 날짜, 잃어버린 장소, 사진링크는 반드시 작성해야 합니다.
